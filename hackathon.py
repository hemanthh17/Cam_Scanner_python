...
saving = cv2.imwrite('/home/hemanth/Desktop/Hackathon/primary.jpg',dst)
print(dimensions)
cv2.destroyAllWindows()
image_list = []

from PIL import Image
pdf1_filename = "/home/hemanth/Desktop/Hackathon/primary.pdf"
img1 = Image.open('/home/hemanth/Desktop/Hackathon/primary.jpg')
im1= img1.convert('RGB')
im1.save('/home/hemanth/Desktop/Hackathon/primary1.pdf')
